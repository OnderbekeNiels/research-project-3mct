...
export default function Post() {
  ...
  const { votesCount, answerCount, title, body, ownerUser, tags } = post;

  const [formatedTags, setFormatedTags] = useState<string[]>(formatTags(tags));
    ...
    <ContentBox className="grid grid-cols-[auto_1fr_auto_auto] gap-4">
      ...
      <div className="text-gray-900">
        ...
        <p className="mt-2 text-sm">
          asked by{" "}
          <span className="font-bold text-orange-600">{ownerUser}</span>
        </p>
      </div>
