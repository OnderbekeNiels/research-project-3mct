...
export default function RequestMetrics() {
  ...
  return (<>
    <aside className="fixed bottom-8 left-0 right-0 p-4 bg-gray-800/75 backdrop-blur-lg w-full max-w-xl mx-auto text-white rounded-md z-50 opacity-20 hover:opacity-100">
